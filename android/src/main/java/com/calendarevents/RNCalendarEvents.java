...
public class RNCalendarEvents extends ReactContextBaseJavaModule implements PermissionListener {
    ...
    private WritableNativeMap serializeEvent(Cursor cursor) {
        ...
        Log.i("ReactNative", String.valueOf(foundEndDate.get(Calendar.DAY_OF_MONTH)), String.valueOf(foundEndDate.get(Calendar.HOUR_OF_DAY)), String.valueOf(foundEndDate.get(Calendar.MINUTE)));
        if (allDay && foundEndDate.get(Calendar.DAY_OF_MONTH) != foundStartDate.get(Calendar.DAY_OF_MONTH)) {
            ...
            foundEndDate.set(Calendar.MINUTE, 59);      // Set minute to 59
            foundEndDate.set(Calendar.SECOND, 59);      // Set second to 59
            endDateUTC = sdf.format(foundEndDate.getTime());
        }
